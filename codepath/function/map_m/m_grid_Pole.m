...
if ~isempty(xtick)
 ...
 line(reshape([X;NaN+ones(1,m)],(n+1)*m,1),reshape([Y;NaN+ones(1,m)],(n+1)*m,1),...
      'linestyle','none','color',ggridcolor,'linewidth',0.1,'tag','m_grid_xgrid','parent',ax);
 ...
 if drawticks
   ...
   line(reshape([ltx;NaN+ones(1,m)],(n+1)*m,1),reshape([lty;NaN+ones(1,m)],(n+1)*m,1),...
        'linestyle','none','color',[1 1 1],'linewidth',glinewidth,'tag','m_grid_xticks-lower','clipping','off','parent',ax,'Visible','off');
   line(reshape([utx;NaN+ones(1,m)],(n+1)*m,1),reshape([uty;NaN+ones(1,m)],(n+1)*m,1),...
        'linestyle','none','color',[1 1 1],'linewidth',glinewidth,'tag','m_grid_xticks-upper','clipping','off','parent',ax,'Visible','off');
 end
